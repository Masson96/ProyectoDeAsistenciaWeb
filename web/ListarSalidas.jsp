            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="card-header">
                        ...
                        <div class="col-sm-8">
                            <table name="tableturno" class="table table-hover table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Nombres</th>
                                ...
                                <tbody>
                                    <c:forEach var="em" items="${salidas}">
                                    <tr>
                                        <td>${em.getidEmpleado()}</td>
                                        <td>${em.getNombres()}</td>
                                        <td>${em.getApellidosPaterno()}</td>
                                        <td>${em.getApellidoMaterno()}</td>
                                        <td>${em.getDniEmpleado()}</td>
                                        <td>${em.getDescActividad()}</td>
                                        <td>${em.getsalida()}</td>
                                    </tr>
                                    </c:forEach>
                                </tbody>
