<%-- 
    ...
    Created on : 16/12/2019, 03:22:50 AM
    Author     : Masson
--%>
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <br>
                    <div class="navbar">
                        <a class="btn btn-outline-success"  href="VistaEmpleado/add.jsp">Nuevo</a>
                        <form class="form-inline" action="Controlador?menu=BuscarEmple" method="POST">
                            <input type="text" name="txtBuscar" value="${em.getDni()}" class="form-control">
                            <input type="submit" name="accion" value="Buscar" class="btn btn-outline-success">
                            <a href="ReporteEmpleado.jsp">Generar Reporte</a>
                        </form>
                    </div>
                    <br>
                    <br>
                    <br>
                    <div class="col-sm-12">
                        <table name="datatable" class="table table-hover table-bordered table-striped table-responsive">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <c:forEach var="em" items="${empleados}">
                                    <tr>
                                        <td class="text-center">${em.getIdEmpleado()}</td>
                                        <td class="text-center">${em.getNombres()}</td>
                                        <td class="text-center">${em.getApellidoPaterno()}</td>
                                        <td class="text-center">${em.getApellidoMaterno()}</td>
                                        <td class="text-center">${em.getDni()}</td>
                                        <td class="text-center">${em.getGenero()}</td>
                                        <td class="text-center">${em.getDireccion()}</td>                           
                                        <td class="text-center">${em.getTelefono()}</td>
                                        <td class="text-center">${em.getCorreo()}</td>
                                        <td class="text-center">${em.getDescanso()}</td>
                                        <td class="text-center">${em.getFecha_hora()}</td>
                                        <td class="text-center">${em.getTurno()}</td>
                                        <td>
                                            <a class=" btn btn-warning" href="Controlador?menu=EditarEmp&accion=eddit&id=${em.getIdEmpleado()}">Editar</a>                       
                                            <a class="btn btn-danger" href="Controlador?menu=DeleteEmp&accion=Delete&id=${em.getIdEmpleado()}">Eliminar</a>                       
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
