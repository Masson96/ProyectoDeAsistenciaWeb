                ...
                <div id="content">
                    ...
                    <div class="container">
                        ...
                        <div class="text-center" >
                            <h1>Bienvenido Sr(a)...</h1>
                            <div class="col-sm-12 bg-3">
                                <input class="col-sm-6 text-center"type="text" disabled="disabled" name="nombresempleado" value="${em.getNombres()} ${em.getApellidoPaterno()} ${em.getApellidoMaterno()}" placeholder="Datos Empleado">
                            </div><br>
                            <div>
                                <input type="submit" class="btn btn-outline-primary" value="Entrada">
                                <input type="submit" class="btn btn-outline-danger" value="Salida">
                            </div>
                        </div>
                    </div>
                    <%--FIN DE CONTENIDO --%>
