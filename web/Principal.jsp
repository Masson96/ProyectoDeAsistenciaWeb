        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <form action="Controlador?menu=BuscarEmpleado" method="POST">
                        <div class="form-group text-center">
                            <h3>Por favor, coloque su huella sobre el lector...</h3>
                            <br><br>
                            ...
                            <div>
                                <label>DNI :</label>
                                <input type="text" name="dniempleado" value="${em.getDni()}" class="">
                                <input type="submit" name="accion"  value="Aceptar" class="btn btn-outline-info">
                            </div>
                        </div>
                    </form>
                    </body> 
