                            ...
                            <div class="card position-relative">
                                ...
                                <div class="card-body">
                                    <form class="form-row">
                                        ...
                                        <br>
                                        <a class="btn btn-info col-sm-2 pb-2" href="#">Cargar</a>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="col-sm-6">
                            <div class="card position-relative">
                                ...
                                <div class="card-body">
                                    <form class="form-row">
                                        <div class="col-sm-4 pb-3">
                                            <label>Tipo de Justifiacion :</label><br>
                                            <select class="form-control" name="idjustificacion">
                                                <option>Seleccione</option>
                                                <option>Accidente</option>
                                                <option>Decanso Médico</option>
                                                <option>Duelo</option>
                                            </select>
                                        </div>
                                    </form>
