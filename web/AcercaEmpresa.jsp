        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!-- Inicio de contenido-->
                    <div class="card-body">
                        <h3>Norkys es la cadena de restaurantes peruana líder dedicada a la venta de pollos y parrilladas a nivel nacional. Su misión es consolidarse y mantener este liderazgo en el mercado con mayor cobertura y calidad en el servicio que ofrecen a sus clientes, brindando atención, comodidad y entretenimiento familiar, con el apoyo de nuestros colaboradores y proveedores en una cadena de sabor peruano que nos une.
                            Inicia sus operaciones en septiembre de 1976 con la apertura del primer restaurante ubicado en la Av. Abancay 648, el cual funciona hasta el día de hoy. La empresa ha crecido progresivamente, con 40 años en el mercado, cuenta en la actualidad con 146 tiendas entre restaurantes y patios de comida, tanto en Lima como en Provincias.</h3><br>
                        <div class="card">

                            <label><h3>MISION:</h3></label>
                            <h3>
                                Norky’s dio sus inicios con un local ubicado en el centro de Lima. En principio se dio como un negocio familiar pero al tener una buena aceptación por sus clientes esta empezó a ampliar su carta con variedad de platos así como la facilidad de encuentro con sus público.
                                Actualmente la cadena de restaurante de pollos a la brasa y parrilladas más grande de Lima, ubicándose a su vez en Chiclayo, Trujillo, Ica, Arequipa y Huancayo.
                            </h3>
                        </div><br>
                        <div class="card">
                            ...
                            <h3>
                                Es el de consolidarse como la cadena más exitoso de pollo a la brasa y parrilladas a nivel nacional.
                            </h3>
                        </div>
                    </div>
                    <img src="images/logo.png" alt="100" width="270"/>
