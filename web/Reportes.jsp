        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div id="bannerreport" class="card-header">
                        <h2>Reportes</h2>
                        <h4>Cálculo y generación de reportes</h4>
                    </div><br>
                    <div class="col-sm-10">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Búsqueda y carga</h6>
                            </div>
                            <div class="card-body">
                                <form class="form-row">
                                    <div class="col-3">
                                ...
                                <br>
                                <a class="btn btn-info col-sm-5 pb-2" href="#" type="">Carga para todos los empleados</a>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="col-sm-10">
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Calculo de horas trabajadas</h6> 
                            </div>
                            <div class="card-body">
                                <form class="form-row">
